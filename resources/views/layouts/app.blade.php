        ...
        <div class="container">
            ...
            <div class="ml-auto navbar-collapse collapse nav-content">
                <ul class="nav navbar-nav mx-md-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/{{$lang->title}}/hot-tours">{{$lang->data->hot_tours}}</a>
                    </li>
            ...
            <div class="col-md-6 order-md-2 order-1">
                <div class="row">
                    ...
                    <div class="col-9">
                        ...
                        <div class="desc-content">
                            <p style="font-size: 18px; margin-bottom: 0"> 1 <i class="fa fa-dollar"></i> = <span
                                        class="dollar_usz">0</span></p>
                            <p style="font-size: 18px; margin-bottom: 0"> 1 <i class="fa fa-euro"></i> = <span
...
<div class="block-footer col-12">
    <div class="row">
        <div class="col-md-6 order-md-1 order-2">
            <p class="copyright">
                2018 © Ulysse Tour. All rights reserved. Design and development by <a href="https://limitless.uz"
...
@if( isset($setting['request_tour']) && $setting['request_tour'])
    <!-- Modal -->
    <div class="modal fade" id="modalRequestTour" tabindex="-1" role="dialog" aria-labelledby="modalRequestTourTitle"
         aria-hidden="true">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="number_of_tourists_request"
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="visa_support"
                                ...
                                <div class="col-6">
                                    @if($search['country'] == 1)
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="join_group"
                                    ...
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="train_tickets"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control " id="shooting_range_request" name="shooting_range">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control " id="transport_request" name="transport">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control " id="category_of_hotels" name="category_of_hotels">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control " id="guide_sevice_request" name="guide_sevice">
