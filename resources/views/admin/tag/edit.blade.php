            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form class="was-validated" method="POST" action="/admin/guide/{{$guide->id}}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="meta_title" name="meta_title"
                                               placeholder="Введите название" value="{{$guide->meta_title}}" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="url">Ссылка (Url)</label>
                                        <input type="text" class="form-control" id="url" name="url"
                                               placeholder="Введите название" value="{{$guide->url}}" required>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="meta_desc" name="meta_description" required
                                                  rows="5">{{$guide->meta_description}}</textarea>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="title" name="title"
                                       placeholder="Введите название" required value="{{$guide->title}}">
                            </div>
                                ...
                                <select class="form-control" name="lang" id="lang" required>
                                    @foreach($lang as $item)
                                        <option value="{{$item->title}}"
                                                @if($item->title === $guide->lang) selected @endif
                                        >{{$item->title}}</option>
                                    @endforeach
                                </select>
                            </div>
