        ...
        <div class="row ">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="was-validated" action="/admin/tour/create/{{$lang}}" enctype="multipart/form-data" method="post">
                            {!! csrf_field() !!}
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="image-select" class="image-selection">
                                            ...
                                            <img src="" class="hideme out-image" id="out-image" alt="img">
                                        </label>
                                    </div>
                                </div>
