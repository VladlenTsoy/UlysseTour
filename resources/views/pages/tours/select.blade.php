...
@section('content')
    <div class="block-content container">
        <div class="col-12 details-tour">
            <div class="row">
                <div class="col-md-7">
                    <span class="title-block">{{$lang->data->information}}</span>
                    <table class="table table-sm">
                        <tr>
                            <td class="title">{{$lang->data->durations}}</td>
                            <td class="desc">{{$tour->duration}}</td>
                        </tr>
                        <tr>
                            <td class="title">{{$lang->data->category}}</td>
                            <td class="desc">{{$tour->category_title}}</td>
                        </tr>
                        @if(isset($hot))
                            <tr>
                                <td class="title">{{$lang->data->hot_date}}</td>
                                <td class="desc">{{ date('d-m-Y', strtotime(date($tour->hot)))}}</td>
                            </tr>
                        @endif
                        <tr>
                            <td class="title">{{$lang->data->cities}}</td>
                            <td class="desc">
                        ...
                        <tr>
                            <td class="title">{{$lang->data->season}}</td>
                            <td class="desc">{{$tour->season_title}}</td>
                        </tr>

                        <tr>
                            <td class="title">{{$lang->data->count_people}}</td>
                            <td class="desc">{{$tour->max_qty_tourists}}</td>
                        </tr>

                        <tr>
                            <td class="title">{{$lang->data->cost}}</td>
                    ...
                    <div class="block-btn-cost row">
                        <div class="col-md-6 text-right">
                            <button class="btn btn-warning" data-toggle="modal" data-target="#modalSchedule">
                                <i class="fa fa-plane"></i> {{$lang->data->schedule}}
                            </button>
                        </div>
                        <div class="col-md-6">
                            <button class="btn btn-primary" data-toggle="modal"
                                    data-target="#modalBookIt">{{$lang->data->book_it}}</button>
                        </div>
                    </div>
    ...
    <div class="block-content block-mini-desc">
        <div class="container">
            <span class="title">{{$lang->data->description}}</span>
    ...
    <div class="block-content block-programs">
        <div class="container">
            <div class="col-12">
                <div class="row">
                    <div class="col-md-6">
                        <span class="title">{{$lang->data->program_tour}}</span>
                    </div>
                    <div class="col-md-6 text-right">
                        <a class="sub-option-program openall"
                           href="javascript:openAllProgram(true)">{{$lang->data->open_all}}</a>
                        <a class="sub-option-program closeall" style="display: none"
                           href="javascript:openAllProgram(false)">{{$lang->data->close_all}}</a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-header" id="heading-{{$key+1}}">
                            <h5 class="mb-0">
                                <button class="btn btn-link trigger collapsed" type="button" data-toggle="collapse"
                                    ...
                                    {{$lang->data->day}} {{$key+1}} : {{$item->title}}
                                </button>
                            </h5>
                        </div>
        ...
        <div class="container">
            <div class="col-12">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <span class="title text-center">{{$lang->data->include}}:</span>
                        <div class="desc-content row" style="font-size: 16px">
                            ...
                            @if(count($transports) !== 0)
                                <div class="col-12">- <a href="javascript:void(0)" data-toggle="modal"
                                                         data-target="#modalTransport">{{$lang->data->transports}}</a>;
                                </div>
                            @endif
                            @if(count($guideService) !== 0)
                                <div class="col-12">- <a href="javascript:void(0)" data-toggle="modal"
                                                         data-target="#modalGuideService">{{$lang->data->guide_sevice}}</a>;
                                </div>
                            @endif
                            @if(count($food) !== 0)
                                <div class="col-12">- <a href="javascript:void(0)" data-toggle="modal"
                                                         data-target="#modalFood">{{$lang->data->food}}</a>;
                                </div>
                            @endif
                            @if(count($accommodations) !== 0)
                                <div class="col-12">- <a href="javascript:void(0)" data-toggle="modal"
                                                         data-target="#modalAccommodations">{{$lang->data->accommodations}}</a>;
                                </div>
                            @endif
                    ...
                    <div class="col-md-6">
                        <span class="title text-center">{{$lang->data->sub_service}}:</span>
    ...
    @if($tour->conditions)
        <div class="block-content block-programs">
            <div class="container">
                <span class="title">{{$lang->data->conditions}}</span>
                <div class="desc-content" style="font-size: 16px">
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalTransportTitle">{{$lang->data->transports}}</h5>
    ...
    <div class="modal fade bd-example-modal-lg" id="modalGuideService" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalGuideServiceTitle">{{$lang->data->guide_sevice}}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <div class="modal fade bd-example-modal-lg" id="modalAccommodations" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalAccommodationsTitle">{{$lang->data->accommodations}}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <div class="modal fade bd-example-modal-lg" id="modalFood" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalFoodTitle">{{$lang->data->food}}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <div class="modal fade bd-example-modal-lg" id="modalBookIt" tabindex="-1" role="dialog" aria-labelledby="modal"
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal">{{$lang->data->book_it}}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="first_name">{{$lang->data->first_name}}</label>
                                ...
                                <div class="form-group">
                                    <label for="citizenship">{{$lang->data->citizenship}}</label>
                                    <input type="text" class="form-control" id="citizenship" name="citizenship"
                                           required>
                                </div>

                                <div class="form-group">
                                    <label for="number_of_tourists">{{$lang->data->number_of_tourists}}</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="last_name">{{$lang->data->last_name}}</label>
                                    <input type="text" class="form-control" id="last_name" name="last_name" required>
                                </div>

                                <div class="form-group">
                                    <label for="cellphone">{{$lang->data->cellphone}}</label>
                                ...
                                <div class="form-group">
                                    <label for="dates">{{$lang->data->dates}}</label>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="preference_for_food">{{$lang->data->preference_for_food}}</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="room_share">{{$lang->data->room_share}}</label>
                                    <textarea name="room_share" id="room_share" class="form-control"></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="additional_info">{{$lang->data->additional_info}}</label>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <button class="btn btn-primary btn-block" form="book_it_form"
                                        type="submit">{{$lang->data->book_it}}</button>
                                <br>
                            </div>
                            <div class="col-md-6">
                                <button type="button" class="btn btn-secondary btn-block"
                                        data-dismiss="modal">{{$lang->data->close}}</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal fade bd-example-modal-lg" id="modalSchedule" tabindex="-1" role="dialog" aria-labelledby="modal"
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal">{{$lang->data->schedule}}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="col-12 wrap-rasp-form">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="from_schedule" class="secondGreyColor">{{$lang->data->from}}</label>
                                    <select name="" class="form-control form-control-sm" id="from_schedule">
                                        <optgroup label="">
                                            <option value="c10335" selected="">{{$lang->data->c10335}}</option>
                                            <option value="c10336">{{$lang->data->c10336}}</option>
                                            <option value="c10330">{{$lang->data->c10330}}</option>
                                            <option value="c10331">{{$lang->data->c10331}}</option>
                                            <option value="c21314">{{$lang->data->c21314}}</option>
                                            <option value="c10296">{{$lang->data->c10296}}</option>
                                            <option value="c10337">{{$lang->data->c10337}}</option>
                                            <option value="c10334">{{$lang->data->c10334}}</option>
                                            <option value="c10338">{{$lang->data->c10338}}</option>
                                            <option value="c21105">{{$lang->data->c21105}}</option>
                                        </optgroup>
                                        <optgroup label="">
                                            <option value="c11508">{{$lang->data->c11508}}</option>
                                            <option value="c10562">{{$lang->data->c10562}}</option>
                                            <option value="c10604">{{$lang->data->c10604}}</option>
                                            <option value="c213">{{$lang->data->c213}}</option>
                                            <option value="c10445">{{$lang->data->c10445}}</option>
                                            <option value="c131">{{$lang->data->c131}}</option>
                                            <option value="c26816">{{$lang->data->c26816}}</option>
                                            <option value="c10620">{{$lang->data->c10620}}</option>
                                            <option value="c10590">{{$lang->data->c10590}}</option>
                                            <option value="c11499">{{$lang->data->c11499}}</option>
                                            <option value="c10616">{{$lang->data->c10616}}</option>
                                            <option value="c202">{{$lang->data->c202}}</option>
                                            <option value="c10635">{{$lang->data->c10635}}</option>
                                            <option value="c10594">{{$lang->data->c10594}}</option>
                                            <option value="c100">{{$lang->data->c100}}</option>
                                            <option value="c10393">{{$lang->data->c10393}}</option>
                                            <option value="c10502">{{$lang->data->c10502}}</option>
                                            <option value="c20843">{{$lang->data->c20843}}</option>
                                            <option value="c10448">{{$lang->data->c10448}}</option>
                                            <option value="c10619">{{$lang->data->c10619}}</option>
                                        </optgroup>
                                        <optgroup label="">
                                            <option value="c22177">{{$lang->data->c22177}}</option>
                                            <option value="c10318">{{$lang->data->c10318}}</option>
                                            <option value="c62">{{$lang->data->c62}}</option>
                                            <option value="c39">{{$lang->data->c39}}</option>
                                            <option value="c55">{{$lang->data->c55}}</option>
                                            <option value="c163">{{$lang->data->c163}}</option>
                                            <option value="c54">{{$lang->data->c54}}</option>
                                            <option value="c35">{{$lang->data->c35}}</option>
                                            <option value="c2">{{$lang->data->c2}}</option>
                                            <option value="c172">{{$lang->data->c172}}</option>
                                            <option value="c10253">{{$lang->data->c10253}}</option>
                                            <option value="c22">{{$lang->data->c22}}</option>
                                            <option value="c11063">{{$lang->data->c11063}}</option>
                                            <option value="c51">{{$lang->data->c51}}</option>
                                            <option value="c193">{{$lang->data->c193}}</option>
                                            <option value="c10309">{{$lang->data->c10309}}</option>
                                            <option value="c43">{{$lang->data->c43}}</option>
                                            <option value="c157">{{$lang->data->c157}}</option>
                                            <option value="c65">{{$lang->data->c65}}</option>
                                            <option value="c239">{{$lang->data->c239}}</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="to_schedule" class="secondGreyColor">{{$lang->data->to}}</label>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="date" class="secondGreyColor">{{$lang->data->data_to}}</label>
                                ...
                                <div class="form-group form-group-xs">
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        <label class="custom-control-label secondGreyColor"
                                               for="checkDateTo">{{$lang->data->data_from}}</label>
                                    </div>
                            ...
                            <div class="col-md-12">
                                <button class="btn btn-primary btn-sm btn-block" id="send"
                                        type="button">{{$lang->data->search}}</button>
                            </div>
                            {{--*************************************--}}
                            ...
                            <div class="col-md-12 wrap-rasp hideme">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" id="air-rasp-tab" data-toggle="tab" href="#air-rasp"
                                           role="tab" aria-controls="air-rasp" aria-selected="true">
                                            <i class="fa fa-plane" aria-hidden="true"></i> {{$lang->data->plane}}
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile"
                                           role="tab" aria-controls="profile" aria-selected="false">
                                            <i class="fa fa-train" aria-hidden="true"></i> {{$lang->data->train}}
                                        </a>
                                    </li>
                                </ul>
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="air-rasp" role="tabpanel"
                                        ...
                                        <div class="col-12">
                                            <h3 class="title">{{$lang->data->schedule}}</h3>
                                        </div>
                                        {{----}}
    ...
    <script>
        ...
        var langSchedule = {
                'load': '{{$lang->data->load}}',
                'error': '{{$lang->data->error}}',
                'empty': '{{$lang->data->empty}}',
                'company': '{{$lang->data->company}}',
                'room': '{{$lang->data->room}}',
                'route': '{{$lang->data->route}}',
                'departure': '{{$lang->data->departure}}',
                'arrival': '{{$lang->data->arrival}}',
            }
    </script>
@endsection