...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <button class="btn btn-primary btn-block" data-toggle="modal"
                            data-target="#modalBookItBussinesUser">{{$_lang->data->book_it}}</button>
                </div>
                <div class="col-md-8">
                    <h2>Направления</h2>
                    <table class="table table-bordered table-responsive-md table-helicopter">
                        ...
                        <th>{{$_lang->data->number_of_passengers}}</th>
                        <th></th>
                        </thead>
                        <tbody>
    ...
    {{----}}
    <div class="modal fade bd-example-modal-lg" id="modalBookItBussinesUser" tabindex="-1" role="dialog" aria-labelledby="modal"
         aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form id="book_it_form_helicopter_use">
                        <div class="row">
                            <div class="col-12">
                                <div class="alert alert-success alert-message" style="display: none" role="alert">
                                    {{$_lang->data->data_message_send}}
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="direction">{{$_lang->data->direction}}</label>
                ...
                <div class="modal-footer">
                    <div class="col-12">
                        <div class="row">
                            <div class="col-md-6">
                                <button class="btn btn-primary btn-block" form="book_it_form_helicopter_use"
                                        type="submit">{{$_lang->data->book_it}}</button>
                                <br>
                            </div>
                            <div class="col-md-6">
