...
$(document).ready(function () {
    ...
    //     day = $('.program-block .block-current-program').length === 0 ? 1 : $('.program-block .block-current-program').length + 1;
    //     $('.program-block .block-current-program:not(:last-child)').find('.deleteButton').css('display', 'none');
    //     $('.program-block .block-current-program:last-child').find('.deleteButton').css('display', 'inline-block');
    //     if (bl)
    //         for (let i = 1; i <= day; i++) {
    //             ClassicEditor.create(document.querySelector('#day_' + i), dayProgramSetting).catch(error => {
    //                 console.error(error)
    //             })
    //         }
    // }
    ...
    //     $(e.currentTarget).parents('.block-current-program').remove();
    //     update();
    //     day--
    // }
    //
    ...
    //     $('.image-selection').removeClass('success');
    //     $('.out-image').addClass('hideme');
    //     reader.onload = function () {
    //         $('#out-image').attr('src', reader.result).removeClass('hideme');
    //         $('.image-selection').addClass('success')
    //     };
    ...
    // }
    // if ($('.js-ad-multiple')) {
    //     $('.js-ad-multiple').select2();
    //     $(".js-ad-multiple").on("select2:select", function (evt) {
    //         let element = evt.params.data.element;
    //         let $element = $(element);
    //         $element.detach();
    //         $(this).append($element);
...
window.initMap = function initialize() {
    ...
    console.log($('#map', document).length);
